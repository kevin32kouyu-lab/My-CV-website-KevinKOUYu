...
export const siteProfile = {
  ...
  summary:
    "拥有 2 年半 ABB 复杂自动化系统集成经验，现为香港中文大学机器人学硕士在读，专业排名前 5%。我擅长把复杂商业需求拆解为 Agent 工作流，也能把软硬件系统推进到真实交付。",
  jobPreference: {
    title: "求职意向",
    description: "当前求职城市优先级为深圳、上海、香港，优先关注 AI 产品、Agent 系统和机器人相关岗位。",
    priorities: ["深圳", "上海", "香港"],
  },
  basicProfile: [
    { label: "年龄", value: "26岁" },
