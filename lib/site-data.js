...
export const siteProfile = {
  ...
  summary:
    "拥有 2 年半 ABB 复杂自动化系统集成经验，现为香港中文大学机器人学硕士在读，专业排名前 5%。我熟练使用 Codex、Claude、TRAE 等 AI 工具，希望把工业现场训练出的需求拆解、系统协同和交付意识，用到 AI Agent 产品与应用系统建设中。",
  resume: {
    label: "下载简历",
  ...
  basicProfile: [
    ...
    { label: "AI工具", value: "Codex / Claude / TRAE" },
...
export const aboutPage = {
  ...
  background: {
    ...
    paragraphs: [
      ...
      "我熟练使用 Codex、Claude 和 TRAE 等 vibe coding 工具，也有 OpenClaw、Hermes、Notebook LLM、Midjourney、Seedance、Stitch 等 AI 工具的深度使用经验。",
  ...
  skillGroups: [
    ...
    },
    {
      ...
      icon: Sparkle,
      items: ["Codex", "Claude", "TRAE", "OpenClaw", "Hermes", "Notebook LLM", "Midjourney", "Seedance", "Stitch"],
    },
    {
      title: "编程与后端",
      icon: Code,
